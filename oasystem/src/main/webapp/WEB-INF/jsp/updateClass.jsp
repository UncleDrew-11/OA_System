		...
		<div class="top_ ">
			<p class="h1">修改部门信息</p>
				...
				<div id="content1">
					...
					<form action="handle/updateClass" method="post">
					<input type="text" class="inputStr" name="idg" style="visibility:hidden"/>
					<table class="table">

						<tr>
							<td valign="middle" align="right">ID:</td>
							<td valign="middle" align="left"><input type="text" class="inputStr" name="id" /></td>
						</tr>
						<tr>
							<td valign="middle" align="right">部门名:</td>
